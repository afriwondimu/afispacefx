    ...
    <div className='lg:pl-24 md:pl-16 pl-6'>
        <div className='flex max-md:flex-col-reverse my-8 items-center lg:gap-x-5 sm:my-12 md:my-16 pb-6 md:pb-20 md:flex-row'>
            <div className='py-4 mb-2 w-full'>
                <motion.div initial={{opacity:0, x:30}} whileInView={{opacity:1, x:0}} transition={{type:'tween', duration:0.3}} className='md:pr-6'>
                    <h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#944734]"><span className='font-semibold text-black'>Discord</span>  our vibrant community where aspiring traders gather to share insights, strategies, and experiences. Our dedicated server offers a supportive environment for learning and growth, ensuring you have the tools and resources needed to thrive in forex trading.</h2> 
                    <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://discord.gg/47ENshX6Vt" className='py-1 inline-block text-xl text-black font-semibold'>
                        Join the Server Space 
            ...
            <motion.div initial={{opacity:0, y:30}} whileInView={{opacity:1, y:0}} transition={{type:'tween', duration:0.3}} className='py-4 px-6 w-full'>
                <div className='relative'>
                    <div className='relative'>
                        <div className='md:absolute z-[1] top-[-300px] lg:top-[-350px] right-0 shadow-2xl border-[#a0a0a0] border-[2.9px] rounded-xl'>
                        <img src="https://raw.githubusercontent.com/afriwondimu/assets/main/assets/disss.jpg" alt="" loading="lazy" decoding="async" width="1190" height="1000" className="w-full h-auto d-block rounded-lg" />
                        </div>  
                    </div>
                </div>
            </motion.div>
        ...
        <motion.div initial={{opacity:0, x:-30}} whileInView={{opacity:1, x:0}} transition={{type:'tween', duration:0.3}} className='mb-10 md:mb-32 pb-4 '>
            <div className='py-4 text-left'>
                <h3 className="text-[#964d3b] mb-2 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium">You Can</h3>
                <p className="mb-3 md:text-xl text-base font-medium text-black">With vibrant community on Discord</p>
            </div>
        </motion.div>
    </div>
  </div>
